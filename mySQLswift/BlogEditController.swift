...
class BlogEditController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl.addTarget(self, action: #selector(BlogEditController.refreshData), forControlEvents: UIControlEvents.ValueChanged)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if tableView == self.tableView {
            ...
            cell.replylikeButton .addTarget(self, action: #selector(BlogEditController.likeButton), forControlEvents: UIControlEvents.TouchUpInside)

...
class SalesmanController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        titleButton.setTitle("mySalesman", forState: UIControlState.Normal)
        ...
        self.refreshControl.addTarget(self, action: #selector(SalesmanController.refreshData), forControlEvents: UIControlEvents.ValueChanged)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if (tableView == self.tableView) {
            ...
            cell.salestitleLabel!.text = _feedItems[indexPath.row] .valueForKey("Salesman") as? String
            
        } else {
            
            cell.salestitleLabel!.text = filteredString[indexPath.row] .valueForKey("Salesman") as? String

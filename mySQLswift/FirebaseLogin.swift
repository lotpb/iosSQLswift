...
class FirebaseLogin: UIViewController, FBSDKLoginButtonDelegate, GIDSignInUIDelegate, GIDSignInDelegate {
    ...
    func registerNewUser() {
        ...
        FIRAuth.auth()?.createUserWithEmail(email, password: password, completion: { (user: FIRUser?, error) in
            ...
            if error == nil {
                ...
                let ref = FIRDatabase.database().referenceFromURL("https://thelight-da74.firebaseio.com/")
